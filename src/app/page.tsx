            ...
            <div className="flex items-center justify-center space-x-2">
              <span className="text-gray-500 inline-flex items-center space-x-1">
                ...
                <a
                  ...
                  className="inline-flex items-center space-x-1 font-medium text-gray-700 hover:text-gray-900 transition-colors"
                >
                  <span>Ryan X AI</span>
                  <i className="bi bi-house-heart-fill" style={{ fontSize: '1.2rem' }}></i>
                </a>
              </span>
              <span className="text-gray-500" style={{ fontSize: '1.2rem' }}>•</span>
              <a
                href="https://github.com/ryanxai/cvgen-ui"
                target="_blank"
                rel="noopener noreferrer"
